...
//动画移动
+ (void)moveViewWithAnimations:(UIView *)view
                        cgrect:(CGRect)rect
...
//动画添加controller
+ (void) add:(BOOL)add
superViewController:(UIViewController *)superViewCtl
viewController:(UIViewController *)viewCtl
    Duration:(CGFloat)time;
...
+ (UIBarButtonItem *) createNavigationBarItemWithNormalImageName:(NSString *)normalImageName
                                              highlightImageName:(NSString *)highlightImageName
                                                          ...
                                                          action:(SEL)action
                                                          target:(UIViewController *)vtl;

//自定义UIActionSheet
+(UIActionSheet *) initWithTitle:(NSString *)title type:(NSString *)type sender:(UIViewController *)vc;

//创建假的navigationbar
+(UIView *) createNavigationbar:(CGRect)frame
                          title:(NSString *)title
                 withLeftButton:(BOOL)left
...
+ (UIButton *)createButtonWithFrame:(CGRect)rect
                     ...
                     highLightImage:(NSString *)highLight
                              Title:(NSString *)title
                             Target:(id)target
                             Action:(SEL)action;
