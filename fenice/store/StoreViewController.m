...
{
    self.view.frame = CGRectMake(0, 0, SCREENWIDTH, 568);
    self.scrollView.frame = CGRectMake(0, 20, SCREENWIDTH, SCREENHEIGHT-20);
    self.scrollView.contentSize = CGSizeMake(SCREENWIDTH, 548);
}
...
-(void) downloadData {
    ...
    [[HTTPClient shareHTTPClient] getStoreListWithView:self.view Sucess:^(NSMutableArray *cityArr,NSMutableArray *roundArr,NSMutableArray *storeArr){
        ...
        RotateView *rotateView = [[RotateView alloc] initWithFrame:CGRectMake(0, 65, SCREENWIDTH, 360) andImageFrame:CGRectMake(0, 0, SCREENWIDTH, 360) andDataArray:self.dataArray defaultImage:@"store_default_h" pageControl:NO];
